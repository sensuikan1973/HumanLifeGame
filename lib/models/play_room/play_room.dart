...
class PlayRoomModel extends ChangeNotifier {
  ...
  set playerAction(PlayerActionModel playerAction) {
    ...
    _allHumansReachTheGoal = lifeStages.every((lifeStage) => lifeStage.lifeStepModel.isGoal);
  ...
  bool _allHumansReachTheGoal = false;
  bool get allHumansReachTheGoal => _allHumansReachTheGoal;
